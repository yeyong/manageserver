...
namespace SAS.Config
{
    ...
    /// 基本设置管理类
    /// </summary>
    class GeneralConfigFileManager : SAS.Config.DefaultConfigFileManager
    {
        ...
        public new static string ConfigFilePath
        {
            get
            {
                if (filename == null)
                {
                    filename = Utils.GetMapPath(BaseConfigs.GetSitePath + "config/general.config");
                }
