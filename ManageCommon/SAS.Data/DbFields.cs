...
namespace SAS.Data
{
    public class DbFields
    {
        ...
        /// 名片模板信息表字段
        /// </summary>
        public const string CARDTEMPLATES = "[id],[directory],[name],[author],[createdate],[ver],[copyright],[currentfile]";
        /// <summary>
        /// 行业类别字段
        /// </summary>
        ...
        /// 评论字段
        /// </summary>
        public const string COMMENT = "[commentid],[objid],[username],[userid],[userip],[commentdate],[content],[parentid],[scored]";
        /// <summary>
        /// 企业信息字段
        /// </summary>
