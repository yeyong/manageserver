...
namespace SAS.Logic
{
    ...
    {
        private static readonly string configPath = Utils.GetMapPath(BaseConfigs.GetSitePath.ToLower() + "ManagePage/xml/navmenu.config");
        ...
        {
            string jsPath = Utils.GetMapPath(BaseConfigs.GetSitePath.ToLower() + "ManagePage/xml/navmenu.js");
        ...
        {
            Utils.BackupFile(configPath, Utils.GetMapPath(BaseConfigs.GetSitePath.ToLower() + "ManagePage/xml/backup/" + DateTime.Now.ToString("yyyy-MM-dd HH_mm_ss") + ".config"));
        }
        #endregion
    }
}
