<%@ Page Language="C#" CodeBehind="forum_editforums.aspx.cs" Inherits="SAS.ManageWeb.ManagePage.forum_editforums" %>
                        ...
                        <td class="panelbox" align="left">
                            <table width="100%">
                               ...
                               <tr>
							        <td>版主列表:</td>
							        <td>
								        <uc1:TextareaResize id="moderators" runat="server" HintTitle="提示" Width="450px" HintInfo="当前版块版主列表，以&amp;quot;,&amp;quot;进行分割" 
