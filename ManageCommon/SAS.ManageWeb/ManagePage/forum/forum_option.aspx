<%@ Page Language="C#" CodeBehind="forum_option.aspx.cs" Inherits="SAS.ManageWeb.ManagePage.forum_option" %>
            ...
            <tr>
                ...
                <td  class="panelbox" align="right" width="50%">
                    <table width="100%">
		                ...
		                <td><cc1:RadioButtonList id="replynotificationstatus" runat="server" HintInfo="选择是否在回复选项中默认选择" HintTitle="提示" RepeatLayout="flow">
					                <asp:ListItem Value="1">是</asp:ListItem>
					                <asp:ListItem Value="0">否</asp:ListItem>
		                ...
		                <td><cc1:RadioButtonList id="replyemailstatus" runat="server" HintInfo="选择是否在回复选项中默认选择" HintTitle="提示" RepeatLayout="flow">
					                <asp:ListItem Value="1">是</asp:ListItem>
					                <asp:ListItem Value="0">否</asp:ListItem>
				                </cc1:RadioButtonList></td>
		                </tr>
		                <tr>
		                <td>是否启用首页快速发主题:</td>
		                <td><cc1:RadioButtonList id="allowforumindexposts" runat="server" HintInfo="选择是否在首页快速发主题" HintTitle="提示" RepeatLayout="flow">
					                <asp:ListItem Value="1">是</asp:ListItem>
					                <asp:ListItem Value="0">否</asp:ListItem>
				                </cc1:RadioButtonList></td></td>
		                </tr>
                    </table>
                </td>
            </tr>
