<%@ Page Language="C#" CodeBehind="managerbody.aspx.cs" Inherits="SAS.ManageWeb.ManagePage.managerbody" AutoEventWireup="True" %>
...
<body>
    <div class="NavBody">
        ...
        <!--显示快捷菜单-->
        <div id="shortcutmenu" class="DropWindow" style="position: absolute; display: none;
            top: 0px; left: 0px;" onmouseout="setshorcutmenu('none')" onmouseover="setshorcutmenu('block')">
            <dl id="shortcutmenucontent">
            </dl>
        </div>
        <!--显示快捷菜单-->
        <!--显示搜索选项层-->
        <div id="searchoption" class="popupmenu-new" style="position: absolute; display: none;
            top: -8px; right: 154px; width: 50px;" onmouseover="setseachmenu('block')" onmouseout="setseachmenu('none')">
                ...
                <div id="popupmenuitem" class="popupmenu-item" style="padding: 3.5px 0px 4px 0px;">
                    <div>
                        &nbsp;&nbsp;<a href="javascript:void(0);" onclick="javascript:top.topFrame.setseachtype('function');setseachmenu('none');"
                            onfocus="this.blur();">功能</a></div>
                    <div>
                        &nbsp;&nbsp;<a href="javascript:void(0);" onclick="javascript:top.topFrame.setseachtype('user');setseachmenu('none');"
                            onfocus="this.blur();">用户</a></div>
                </div>
            </div>
        </div>
