<%@ Page Language="C#" CodeBehind="global_helplist.aspx.cs" Inherits="SAS.ManageWeb.ManagePage.global_helplist" %>
    ...
    <form id="form1" runat="server" action="">
        <div class="ManagerForm">
            <fieldset>
                ...
                <table width="100%" border="0">
                    ...
                    <%if (helpInfoList != null)
                      {
                          foreach (SAS.Entity.HelpInfo hi in helpInfoList)
                          {
                              string kg = "", id;
                              if (hi.Pid == 0)
                              {
            ...
            <p style="text-align:right;">
                <yy:Button ID="Orderby" runat="server" Text=" 确 定 " ButtonImgUrl="../images/submit.gif"></yy:Button>&nbsp;&nbsp;
                <yy:Button ID="DelRec" runat="server" Text=" 删 除 " ButtonImgUrl="../images/del.gif" Enabled="false" OnClientClick="if(!confirm('你确认要删除所选的帮助项吗？')) return false;"></yy:Button>&nbsp;&nbsp;
