...
{
    public partial class global_helplist : AdminPage
    {
        ...
        {
            #region 删除
            string idlist = SASRequest.GetFormString("id");
        ...
        protected void del(string idlist)
        {
            ...
            AdminVistLogs.InsertLog(userid, username, usergroupid, grouptitle, ip, "删除帮助", "删除帮助,帮助ID为: " + SASRequest.GetString("id"));
        ...
        {
            #region 排序
            string[] orderlist = SASRequest.GetFormString("orderbyid").Split(',');
            string[] idlist = SASRequest.GetFormString("hidid").Split(',');
