            ...
            <Columns>
                <asp:TemplateColumn HeaderText="">
                    <itemtemplate>
						...
						<%# DataGrid1.LoadSelectedCheckBox(DataBinder.Eval(Container, "DataItem.ug_id").ToString())%>
					</itemtemplate>
                </asp:TemplateColumn>
                <asp:TemplateColumn HeaderText="">
                    <itemtemplate>
                ...
                <asp:BoundColumn DataField="ug_scorehight" SortExpression="ug_scorehight" HeaderText="积分下限"></asp:BoundColumn>
                <asp:BoundColumn DataField="ug_scorelow" SortExpression="ug_scorelow" HeaderText="积分上限"></asp:BoundColumn>
                ...
                <asp:BoundColumn DataField="ug_maxsigsize" SortExpression="ug_maxsigsize" HeaderText="签名最多字节" readonly="true"></asp:BoundColumn>
                <asp:BoundColumn DataField="ug_maxattachsize" SortExpression="ug_maxattachsize" HeaderText="附件最大尺寸 [单位:字节]" readonly="true"></asp:BoundColumn>
            </Columns>
        </cc1:DataGrid>
