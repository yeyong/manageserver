<%@ Page Language="C#" CodeBehind="sirius_addactivity.aspx.cs" Inherits="SAS.ManageWeb.ManagePage.sirius_addactivity" %>
    ...
    <script type="text/javascript">
        function add_act() {
            ...
            inputobj.onclick = function() {
                delRow(this);
                finalObj.value = finalObj.value.replace("," + addObj.value, "");
            };
...
<div class="ManagerForm">
    ...
    <fieldset>
        ...
        <div class="Navbutton">
            <yy:button id="AddActInfo" runat="server" text=" 提 交 " validateform="true"></yy:button><input type="hidden" name="selitems" id="selitems"/>
            &nbsp;&nbsp;
