<%@ Page Language="C#" CodeBehind="sirius_editwork.aspx.cs" Inherits="SAS.ManageWeb.ManagePage.sirius_editwork" %>
...
<head>
    ...
    <title>天狼星工作室综合管理后台-编辑团队成果</title>
...
<div class="ManagerForm">
    ...
    <fieldset>
        <legend style="background: url(../images/icons/icon52.jpg) no-repeat 6px 50%;">编辑成果信息</legend>
        <table width="100%">
            <tr>
        ...
        <div class="Navbutton">
            <yy:button id="UpActInfo" runat="server" text=" 提 交 " validateform="true"></yy:button>
            &nbsp;&nbsp;
