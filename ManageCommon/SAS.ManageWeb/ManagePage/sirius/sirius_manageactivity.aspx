<%@ Page Language="C#" CodeBehind="sirius_manageactivity.aspx.cs" Inherits="SAS.ManageWeb.ManagePage.sirius_manageactivity" %>
...
<head>
    ...
    <title>天狼星工作室综合管理后台-团队活动信息列表</title>
        ...
        <cc1:DataGrid ID="DataGrid1" runat="server" IsFixConlumnControls="true" OnPageIndexChanged="DataGrid_PageIndexChanged" OnSortCommand="Sort_Grid">
            <Columns>
                <asp:TemplateColumn HeaderText="">
                    <itemtemplate>
						<a href="sirius_editactivity.aspx?actid=<%# DataBinder.Eval(Container, "DataItem.id").ToString()%>">编辑</a>
                ...
                <asp:BoundColumn DataField="id" SortExpression="id" HeaderText="活动ID" Visible="false"></asp:BoundColumn>
                <asp:BoundColumn DataField="name" SortExpression="name" HeaderText="活动名称"></asp:BoundColumn>
