<%@ Page Language="C#" CodeBehind="taobao_addbrandrecommend.aspx.cs" Inherits="SAS.ManageWeb.ManagePage.taobao_addbrandrecommend" %>
                ...
                <td class="panelbox" width="50%" align="right">
                    <table width="100%">
                        <tr>
                            ...
                            <td>
                                <select name="relateclass" id="relateclass">
