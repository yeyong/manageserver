    ...
    <div class="ManagerForm">
		...
		<table class="table1" cellspacing="0" cellpadding="8" width="100%" align="center" >
		    <tr align="center">
		        ...
		        <td><button type="button" class="ManagerButton" onclick="window.location='taobao_addtopicrecommend.aspx';"><img src="../images/submit.gif" /> 添加活动推荐组</button></td>
                <td><button type="button" class="ManagerButton" onclick="window.location='taobao_addbrandrecommend.aspx';"><img src="../images/submit.gif" /> 添加品牌推荐组</button></td>
		    </tr>
		</table>
		</fieldset>
	</div>
