...
namespace SAS.ManageWeb
{
    public class zswall : CompanyPage
    {
        ...
        protected override void ShowPage()
        {
            ...
            AddLinkCss(rooturl + "templates/" + templatepath + "/css/card.css");
            script += "\r\n<script src=\"" + rooturl + "javascript/jquery-ui.min.js\" type=\"text/javascript\"></script>";
            script += "\r\n<script src=\"" + rooturl + "javascript/jquery.transform-0.6.2.min.js\" type=\"text/javascript\"></script>";
            script += "\r\n<script src=\"" + rooturl + "javascript/jquery.animate-shadow-min.js\" type=\"text/javascript\"></script>";
            script += "\r\n<script src=\"" + rooturl + "javascript/zswall.js\" type=\"text/javascript\"></script>";
        }
    }
}
