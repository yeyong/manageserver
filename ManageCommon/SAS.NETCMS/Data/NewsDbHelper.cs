...
{
    public abstract class NewsDbHelper
    {
        ...
        {
            return ExecuteNonQuery(BaseConfigs.GetNETCMSConnectString, cmdType, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteReader(BaseConfigs.GetNETCMSConnectString, cmdType, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(BaseConfigs.GetNETCMSConnectString, cmdType, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteTable(BaseConfigs.GetNETCMSConnectString, cmdType, cmdText, commandParameters);
        }
        ...
        {
            return ExecutePage(BaseConfigs.GetNETCMSConnectString, SqlAllFields, SqlTablesAndWhere, IndexField, OrderFields, PageIndex, PageSize, out  RecordCount, out  PageCount, commandParameters);
        }
