...
namespace SAS.Taobao.Util
{
    ...
    public abstract class NTWUtil
    {
        ...
        public static NTWContext GetNTWContext(string authCode)
        {
            string url = Constants.NTW_AUTH_URL + authCode;
            ...
            NTWContext context = new NTWContext();
