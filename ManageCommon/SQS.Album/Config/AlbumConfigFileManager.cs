...
namespace SAS.Album.Config
{
    /// <summary>
    /// 相册配置管理类
    /// </summary>
    class AlbumConfigFileManager : SAS.Config.DefaultConfigFileManager
    {
        ...
        public new static string ConfigFilePath
        {
            get
            {
                if (filename == null)
                {
                    filename = Utils.GetMapPath(BaseConfigs.GetSitePath + "config/album.config");
                }
