...
namespace SAS.Control
{
    ...
    public class ColorPicker : SAS.Control.WebControl, IPostBackDataHandler,
        INamingContainer //为子控件提供了一个新的命名范围,保证子控件的ID唯一性
    {
        ...
        /// 拾取文本框
        /// </summary>
        protected SAS.Control.TextBox ColorTextBox = new SAS.Control.TextBox();
        ...
        /// 边框的样式。
        /// </summary>
        [Description("边框的样式。"), Category("Appearance"), DefaultValue(""), TypeConverter(typeof(SAS.Control.BorderStyleConverter))]
