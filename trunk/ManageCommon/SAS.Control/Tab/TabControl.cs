...
namespace SAS.Control
{
    ...
    /// 属性页控件
    /// </summary>
    [ParseChildren(true, "Items"), Description("SAS WebControl TabControl"), ToolboxData("<{0}:TabControl runat=server></{0}:TabControl>"), DefaultEvent("SelectedIndexChanged"), DesignTimeVisible(true), PersistChildren(false), Designer(typeof(TabControlDesigner))]
