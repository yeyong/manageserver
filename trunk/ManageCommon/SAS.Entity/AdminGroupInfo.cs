...
namespace SAS.Entity
{
    ...
    public class AdminGroupInfo
    {
        ...
        private int m_admingid;			//管理组id
        private string m_name;          //管理组名称
        private byte m_pg_allowSys;         //是否允许系统后台登录（默认0，不允许；1，可以登录）
        private byte m_pg_allowSelf;        //是否允许个人后台登录（默认1，允许；0，不允许）
        private byte m_pg_status;           //组别状态（默认1，正常；0，停用）
        private string m_pg_ext1;           //拓展权限1
        ...
        ///<summary>
        ///是否允许系统后台登录（默认0，不允许；1，可以登录）
        ///</summary>
        public byte Pg_allowSys
        {
            get { return m_pg_allowSys; }
            set { m_pg_allowSys = value; }
        }

        ///<summary>
        ///是否允许个人后台登录（默认1，允许；0，不允许）
        ///</summary>
        public byte Pg_allowSelf
        {
            get { return m_pg_allowSelf; }
            set { m_pg_allowSelf = value; }
        }

        ///<summary>
        ///组别状态（默认1，正常；0，停用）
        ///</summary>
        public byte Pg_status
        {
            get { return m_pg_status; }
            set { m_pg_status = value; }
        }

        /// <summary>
        /// 拓展权限1
        /// </summary>
        public string Pg_ext1
        {
            get { return m_pg_ext1; }
            set { m_pg_ext1 = value; }
        }
