...
namespace SAS.Logic
{
    ...
    public class Emails
    {
        ...
        /// <returns></returns>
        public static bool SASSmtpMail(string UserName, string Email, string pass)
        {
            ...
            try
            {
                ...
                ESM.Html = true;
                ESM.Subject = "已成功创建你的 " + configinfo.Sitetitle + "帐户,请查收.";
                ...
                body.Replace("{forumtitle}", configinfo.Sitetitle);
        ...
        /// <returns></returns>
        public static bool SASSmtpMail(string UserName, string Email, string pass, string authstr)
        {
            string forumurl = "http://" + SASRequest.GetCurrentFullHost() + BaseConfigs.GetSitePath.ToLower();
