...
namespace SAS.Logic.ScheduledEvents
{
    ...
    public class Event
    {
        ...
        {
            SAS.Data.DataProvider.Event.SetLastExecuteScheduledEventDateTime(key, servername, lastexecuted);
        }
        ...
        {
            return SAS.Data.DataProvider.Event.GetLastExecuteScheduledEventDateTime(key, servername);
        }
    }
}
