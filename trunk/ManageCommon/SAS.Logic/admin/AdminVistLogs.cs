...
namespace SAS.Logic
{
    ...
    public class AdminVistLogs
    {
        ...
        public static bool InsertLog(int uid, string userName, int groupId, string groupTitle, string ip, string actions, string others)
        {
            try
            {
                SAS.Data.DataProvider.AdminVisitLogs.InsertLog(uid, userName, groupId, groupTitle, ip, actions, others);
                return true;
            }
            catch
            {
        ...
        public static bool DeleteLog()
        {
            try
            {
                SAS.Data.DataProvider.AdminVisitLogs.DeleteLog();
                return true;
            }
            catch
            {
        ...
        public static bool DeleteLog(string condition)
        {
            try
            {
                SAS.Data.DataProvider.AdminVisitLogs.DeleteLog(condition);
                return true;
            }
            catch
            {
        ...
        {
            return SAS.Data.DataProvider.AdminVisitLogs.LogList(pageSize, currentPage);
        }
        ...
        {
            return SAS.Data.DataProvider.AdminVisitLogs.LogList(pageSize, currentPage, condition);
        }
        ...
        {
            return SAS.Data.DataProvider.AdminVisitLogs.RecordCount();
        }
        ...
        {
            return SAS.Data.DataProvider.AdminVisitLogs.RecordCount(condition);
        }
        ...
        {
            return SAS.Data.DataProvider.AdminVisitLogs.DelVisitLogCondition(deleteMod, visitId, deleteNum, deleteFrom);
        }
        ...
        {
            return SAS.Data.DataProvider.AdminVisitLogs.GetVisitLogCondition(postDateTimeStart, postDateTimeEnd, userName, others);
        }
