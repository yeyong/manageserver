...
namespace SAS.ManageWeb.ManagePage
{
    public partial class ajaxtaobaoitems : System.Web.UI.UserControl
    {
        ...
        public string AjaxPagination(long recordcount, int pagesize, int currentpage)
        {
            if (SASRequest.GetInt("postnumber", 0) > 0)
            {
                return AjaxPagination(recordcount, pagesize, currentpage, "../usercontrols/ajaxtaobaoitems.ascx", "itemname=" + itemname + "&postnumber=" + SASRequest.GetInt("postnumber", 0), "taobaoitemlistgrid");
            }
            else
            {
                return AjaxPagination(recordcount, pagesize, currentpage, "../usercontrols/ajaxtaobaoitems.ascx", "itemname=" + itemname, "taobaoitemlistgrid");
            }
        }
