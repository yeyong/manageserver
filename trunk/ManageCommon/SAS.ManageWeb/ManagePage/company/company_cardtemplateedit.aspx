<%@ Page Language="C#" CodeBehind="company_cardtemplateedit.aspx.cs" Inherits="SAS.ManageWeb.ManagePage.company_cardtemplateedit" %>
<%@ Register TagPrefix="yy" Namespace="SAS.Control" Assembly="SAS.Control" %>
<%@ Register Src="../UserControls/TextareaResize.ascx" TagName="TextareaResize" TagPrefix="yy1" %>
...
<table width="100%">
	...
	<tr>
		<td class="vtop rowform">
			<yy:ColorPicker ID="ColorPicker1" runat="server" ReadOnly="True"></yy:ColorPicker>
			<yy1:TextareaResize ID="templatenew" runat="server" controlname="templatenew" is_replace="false" rows="20" cols="120"></yy1:TextareaResize>
		</td>
		<td class="vtop"></td>
	</tr>
	<tr>
...
<p style="text-align:right;width:80%;">
	<yy:Button ID="SavaTemplateInfo" runat="server" Text=" 提 交 "></yy:Button>&nbsp;&nbsp;
	<button class="ManagerButton" type="button" onclick="javascript:window.location.href='company_cardtemplatetree.aspx?templateid=<%=Request.Params["templageid"]%>&path=<%=Request.Params["path"].Split('\\')[0]%>&templatename=<%=Request.Params["templatename"]%>';">
