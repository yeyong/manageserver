    ...
    public partial class forum_addforums : SAS.Web.UI.AdminPage
    {
        ...
        public void InitInfo()
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                td.Controls.Add(new LiteralControl("<input type='checkbox' id='r" + i + "' onclick='selectRow(" + i + ",this.checked)'><label for='r" + i + "'>" + dr["ug_name"].ToString() + "</lable>"));
                tr.Cells.Add(td);
                tr.Cells.Add(GetTD("viewperm", dr["ug_id"].ToString(), i));
                tr.Cells.Add(GetTD("postperm", dr["ug_id"].ToString(), i));
                tr.Cells.Add(GetTD("replyperm", dr["ug_id"].ToString(), i));
                tr.Cells.Add(GetTD("getattachperm", dr["ug_id"].ToString(), i));
                tr.Cells.Add(GetTD("postattachperm", dr["ug_id"].ToString(), i));
            ...
            {
                targetforumid.SelectedValue = SASRequest.GetString("fid");
        ...
        private void SubmitAddChild()
        {
            ...
            if (this.CheckCookie())
            {
                ...
                if (rewritename.Text.Trim() != "" && SAS.Logic.Forums.CheckRewriteNameInvalid(rewritename.Text.Trim()))
                {
                    rewritename.Text = "";
