<%@ Page Language="C#" CodeBehind="forum_forumstree.aspx.cs" Inherits="SAS.ManageWeb.ManagePage.forum_forumstree" %>
...
<body style="overflow: scroll;">
    ...
    <div style="clear: both; position: relative">
        <uc1:PageInfo ID="info1" runat="server" Icon="Information" Text="<li>支持鼠标拖拽</li><li>如需批量设置版块,请设置完一个版块后选择&quot;复制论坛设置&quot;</li>">
        </uc1:PageInfo>
