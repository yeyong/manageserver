<%@ Page Language="C#" CodeBehind="global_addadvs.aspx.cs" Inherits="SAS.ManageWeb.ManagePage.global_addadvs" %>
...
<%@ Register TagPrefix="yy1" TagName="ForumsTree" Src="../UserControls/forumstree.ascx" %>
...
<form id="Form1" method="post" runat="server">
	...
	<yy1:PageInfo id="info1" runat="server" Icon="Information"
	Text="<ul><li>展现方式: 头部横幅广告显示于论坛页面右上方, 通常使用 468x60 图片或 Flash 的形式. 当前页面有多个头部横幅广告时, 系统会随机选取其中之一显示.  </ul>  <ul><li>价值分析: 由于能够在页面打开的第一时间将广告内容展现于最醒目的位置, 因此成为了网页中价位最高、最适合进行商业宣传或品牌推广的广告类型之一. </ul>"></yy1:PageInfo>
	</div>
	<div id="adtype2" style="width:100%;DISPLAY:none">
	<yy1:PageInfo id="PageInfo1" runat="server" Icon="Information"
	Text="<ul><li>展现方式: 尾部横幅广告显示于论坛页面中下方, 通常使用 468x60 或其他尺寸图片、Flash 的形式. 当前页面有多个尾部横幅广告时, 系统会随机选取其中之一显示. </ul>  <ul><li>价值分析: 与页面头部和中部相比, 页面尾部的展现机率相对较低, 通常不会引起访问者的反感, 同时又基本能够覆盖所有对广告内容感兴趣的受众, 因此适合中性而温和的推广. </ul>"></yy1:PageInfo>
	</div>
	<div id="adtype3" style="width:100%;DISPLAY:none">
	<yy1:PageInfo id="PageInfo2" runat="server" Icon="Information"
	Text="<ul><li>展现方式: 页内文字广告以表格的形式, 显示于首页、主题列表和帖子内容三个页面的中上方, 通常使用文字的形式, 也可使用小图片和 Flash. 当前页面有多个文字广告时, 系统会以表格的形式按照设定的显示顺序全部展现, 同时能够对表格列数在 3~5 的范围内动态排布, 以自动实现最佳的广告排列效果.  </ul>  <ul><li>价值分析: 由于此类广告通常以文字形式展现, 但其所在的较靠上的页面位置, 使得此类广告成为了访问者必读的内容之一. 同一页面可以呈现多达十几条文字广告的特性, 也决定了它是一种平民化但性价比较高的推广方式, 同时还可用于论坛自身的宣传和公告之用. </ul>"></yy1:PageInfo>
	</div>
	<div id="adtype4" style="width:100%;DISPLAY:none">
	<yy1:PageInfo id="PageInfo3" runat="server" Icon="Information"
	Text="<ul><li>展现方式: 帖内广告显示于帖子标题的上方, 通常使用文字的形式. 当前页面有多个帖内广告时, 系统会从中抽取与每页帖数相等的条目进行随机显示. 您可以在 Discuz!NT 选项中的其他设置中修改每帖显示的广告数量.  </ul>  <ul><li>价值分析: 由于帖子是论坛最核心的组成部分, 位于帖子内容上方的帖内广告, 便可在用户浏览帖子内容时自然的被接受, 加上随机播放的特性, 适合于特定内容的有效推广, 也可用于论坛自身的宣传和公告之用. 建议设置多条帖内广告以实现广告内容的差异化, 从而吸引更多访问者的注意力. </ul>"></yy1:PageInfo>
	</div>
	<div id="adtype5" style="width:100%;DISPLAY:none">
	<yy1:PageInfo id="PageInfo4" runat="server" Icon="Information"
	Text="<ul><li>展现方式: 漂浮广告展现于页面左下角, 当页面滚动时广告会自行移动以保持原来的位置, 通常使用小图片或 Flash 的形式. 当前页面有多个漂浮广告时, 系统会随机选取其中之一显示.  </ul>  <ul><li>价值分析: 漂浮广告是进行强力商业推广的有效手段, 其在页面中的浮动性, 使其与固定的图片和文字相比, 更容易被关注, 正因为如此, 这种强制性的关注也可能招致对此广告内容不感兴趣的访问者的反感. 请注意不要将过大的图片或 Flash 以漂浮广告的形式显示, 以免影响页面阅读. </ul>"></yy1:PageInfo></div>
	<div id="adtype6" style="width:100%;DISPLAY:none">
	<yy1:PageInfo id="PageInfo5" runat="server" Icon="Information"
	...
	<yy1:PageInfo id="PageInfo6" runat="server" Icon="Information"
	Text="<ul><li>展现方式: Silverlight媒体广告以视频、图片、文字相结合的方式进行展现,通常从屏幕右下角浮现出来.  </ul>  <ul><li>价值分析: 视频背后是大图片广告,视觉冲击效果配合文字描述会带来意想不到的展现效果,是最有效的广告形式. </ul>"></yy1:PageInfo>
	</div>
	<div id="adtype8" style="width:100%;DISPLAY:none">
	<yy1:PageInfo id="PageInfo7" runat="server" Icon="Information"
	Text="<ul><li>展现方式: 帖间通栏广告显示于楼主和2楼帖子之间, 通常使用 728*90 图片或 Flash 的形式. 当前页面有多个帖间通栏广告时, 系统会随机选取其中之一显示.  </ul>  <ul><li>价值分析: 对帖子的质量有举足轻重作用的楼主与沙发之间的黄金地段, 往往容易受到访问者的大量关注. </ul>"></yy1:PageInfo>
	</div>
	<div id="adtype9" style="width:100%;DISPLAY:none">
	<yy1:PageInfo id="PageInfo8" runat="server" Icon="Information"
	Text="<ul><li>展现方式: 分类间广告显示于论坛分类之间  </ul>  <ul><li>价值分析: 当论坛分类过多时, 可能对访问者造成困扰. </ul>"></yy1:PageInfo>
	</div>
	<div id="adtype10" style="width:100%;DISPLAY:none">
	<yy1:PageInfo id="PageInfo9" runat="server" Icon="Information"
	Text="<ul><li>展现方式: 快速发帖栏上方广告显示于发帖框附近  </ul>  <ul><li>价值分析: 当用户想要发帖时必然会看到此类型的广告, 是十分有效的展示方式 </ul>"></yy1:PageInfo>
	</div>
	<div id="adtype11" style="width: 100%; display: none">
		<yy1:PageInfo ID="PageInfo10" runat="server" Icon="information" Text="<ul><li>展现方式: 快速编辑器背景广告  </ul>  <ul><li>价值分析: 当用户想要发帖时必然会看到此类型的广告, 是十分有效的展示方式 </ul>" />
	</div>
    <div id="adtype12" style="width:100%;DISPLAY:none">
	<yy1:PageInfo id="PageInfo11" runat="server" Icon="Information"
	Text="<ul><li>展现方式: 聚合首页头部广告  </ul>"></yy1:PageInfo>
	</div>
	<div id="adtype13" style="width:100%;DISPLAY:none">
	<yy1:PageInfo id="PageInfo12" runat="server" Icon="Information"
	Text="<ul><li>展现方式: 聚合首页热贴下方广告  </ul>"></yy1:PageInfo>
	</div>
    <div id="adtype14" style="width:100%;DISPLAY:none">
	<yy1:PageInfo id="PageInfo13" runat="server" Icon="Information"
	Text="<ul><li>展现方式: 聚合首页发帖排行上方广告  </ul>"></yy1:PageInfo>
	</div>
    <div id="adtype15" style="width:100%;DISPLAY:none">
	<yy1:PageInfo id="PageInfo14" runat="server" Icon="Information"
	Text="<ul><li>展现方式: 聚合首页推荐版块上方广告  </ul>"></yy1:PageInfo>
	</div>
	<div id="adtype16" style="width:100%;DISPLAY:none">
	<yy1:PageInfo id="PageInfo15" runat="server" Icon="Information"
	Text="<ul><li>展现方式: 聚合首页推荐版块下方广告  </ul>"></yy1:PageInfo>
	</div>
	<div id="adtype17" style="width:100%;DISPLAY:none">
	<yy1:PageInfo id="PageInfo16" runat="server" Icon="Information"
	Text="<ul><li>展现方式: 聚合首页推荐相册下方广告  </ul>"></yy1:PageInfo>
	</div>
	<div id="adtype18" style="width:100%;DISPLAY:none">
	<yy1:PageInfo id="PageInfo17" runat="server" Icon="Information"
	Text="<ul><li>展现方式: 聚合首页底部广告  </ul>"></yy1:PageInfo>
	</div>
<fieldset>
...
<table width="100%">
	...
	<tr>
		<td class="vtop rowform">
			<yy:DropDownList id="type" runat="server"></yy:DropDownList>
		</td>
	...
	<tr>
		<td class="vtop rowform" id="paramselect">
			 <yy:DropDownList id="parameters" runat="server"></yy:DropDownList>
		</td>
	...
	<tr>
		<td class="vtop rowform">
			 <yy:Calendar id="starttime" runat="server" ReadOnly="False" ScriptPath="../js/calendar.js"></yy:Calendar>
		</td>
	...
	<tr>
		<td class="vtop rowform">
			 <yy:Calendar id="endtime" runat="server" ReadOnly="False" ScriptPath="../js/calendar.js"></yy:Calendar>
		</td>
	...
	<tr>
		<td class="vtop rowform">
			 <yy:TextBox id="title" runat="server" RequiredFieldType="暂无校验" CanBeNull="必填" Size="60" MaxLength="50"></yy:TextBox>
		</td>
	...
	<tr>
		<td class="vtop" colspan="2">
			<div style="overflow: auto;height: 150px;width:70%;border: 1px double #ccc">
				<yy1:ForumsTree id="TargetFID"  runat="server" HintTitle="提示" HintInfo="设置本广告投放的页面或论坛范围" PageName="advertisement"></yy1:ForumsTree>
			</div>										
		</td>
	</tr>
	</tbody>
	...
	<tr>
		<td class="vtop rowform">
			<yy:RadioButtonList ID="inpostposition" runat="server" RepeatColumns="1">
	...
	<tr>
		<td class="vtop rowform">
			<yy:ListBox ID="inpostfloor" runat="server" HintTopFirefoxOffset="-170" Width="80px">
	...
	<tr>
		...
		<yy:TextBox id="code" runat="server"  Rows="4" IsReplaceInvertedComma="false" HintTitle="提示" HintInfo="请直接输入需要展现的广告的 html 代码" 
			RequiredFieldType="暂无校验" CanBeNull="可为空"  TextMode="MultiLine" width="70%" Height="150" HintLeftOffSet="50"></yy:TextBox>
		</td>
	</tr>
	</tbody>
	...
	<tr>
		<td class="vtop rowform">
			<yy:TextBox id="wordcontent" runat="server" RequiredFieldType="暂无校验" CanBeNull="可为空"></yy:TextBox>
		</td>
	...
	<tr>
		<td class="vtop rowform">
			<yy:TextBox id="wordfont" runat="server" RequiredFieldType="暂无校验" CanBeNull="可为空"></yy:TextBox>
		</td>
	...
	<tr>
		<td class="vtop rowform">
			 <yy:TextBox id="wordlink" runat="server" RequiredFieldType="暂无校验"  CanBeNull="可为空" Text=""></yy:TextBox>
		</td>
	...
	<tr>
		<td class="vtop rowform">
			 <yy:TextBox id="imglink" runat="server" RequiredFieldType="暂无校验" CanBeNull="可为空" Text=""></yy:TextBox>
		</td>
	...
	<tr>
		<td class="vtop rowform">
			<yy:TextBox id="imgsrc" runat="server" RequiredFieldType="暂无校验" CanBeNull="可为空" Text=""></yy:TextBox>
		</td>
	...
	<tr>
		<td class="vtop rowform">
			 <yy:TextBox id="imgtitle" runat="server" RequiredFieldType="暂无校验" CanBeNull="可为空"></yy:TextBox>
		</td>
	...
	<tr>
		<td class="vtop rowform">
			<yy:TextBox id="imgwidth" runat="server" RequiredFieldType="数据校验" CanBeNull="可为空" ></yy:TextBox>px
		</td>
	...
	<tr>
		<td class="vtop rowform">
			<yy:TextBox id="imgheight" runat="server" RequiredFieldType="数据校验" CanBeNull="可为空"></yy:TextBox>px
		</td>
	...
	<tr>
		<td class="vtop rowform">
			<yy:TextBox id="flashwidth" runat="server" RequiredFieldType="数据校验" CanBeNull="可为空"></yy:TextBox> px
		</td>
	...
	<tr>
		<td class="vtop rowform">
			 <yy:TextBox id="flashheight" runat="server" RequiredFieldType="数据校验" CanBeNull="可为空"></yy:TextBox> px
		</td>
	...
	<tr>
		<td class="vtop rowform">
			<yy:TextBox id="flashsrc" runat="server" RequiredFieldType="暂无校验"  CanBeNull="可为空" Text=""></yy:TextBox>
		</td>
	...
	<div class="Navbutton">
		<yy:Button id="AddAdInfo" runat="server" Text=" 提 交 " ValidateForm="true"></yy:Button>&nbsp;&nbsp;
