    ...
    <form id="Form1" method="post" runat="server">
        ...
        <cc1:DataGrid ID="DataGrid1" runat="server" OnPageIndexChanged="DataGrid_PageIndexChanged" OnSortCommand="Sort_Grid">
            <Columns>
                ...
                <asp:BoundColumn DataField="ug_maxsigsize" SortExpression="maxsigsize" HeaderText="签名最多字节"></asp:BoundColumn>
                <asp:BoundColumn DataField="ug_maxattachsize" SortExpression="maxattachsize" HeaderText="附件最大尺寸 [单位:字节]"></asp:BoundColumn>
            </Columns>
        </cc1:DataGrid>
