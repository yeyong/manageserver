<%@ Page Language="C#" CodeBehind="global_editsysadminusergroup.aspx.cs" Inherits="SAS.ManageWeb.ManagePage.global_editsysadminusergroup"%>
...
<head>
    ...
    <title>天狼星工作室综合管理后台-编辑系统组</title>
                                    ...
                                    <td  class="panelbox" width="50%" align="right">
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td>主题(附件)最高售价:</td>
                                                <td>
                                                    <cc1:TextBox ID="maxprice" runat="server" CanBeNull="必填" RequiredFieldType="数据校验" Text="0" Size="5" MaxLength="4" HintInfo="主题(附件)出售使得作者可以将自己发表的主题(附件)隐藏起来,只有当浏览者向作者支付相应的交易积分后才能查看主题(附件)内容.此处设置用户出售主题(附件)时允许设置的最高价格,0 为不允许用户出售."></cc1:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>签名最多字节:</td>
