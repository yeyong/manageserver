<%@ Page Language="C#" CodeBehind="global_edituser.aspx.cs" Inherits="SAS.ManageWeb.ManagePage.global_edituser" %>
                                ...
                                <tr>
                                    ...
                                    <td class="panelbox" align="right">
                                        <table width="100%">
                                            <tr>
                                                <td> 
                                                    <cc1:Button ID="DelPosts" runat="server" Text="删除该用户帖子" HintInfo="该操作将会删除该用户发表过的所有帖子" 
                                                    ButtonImgUrl="../images/del.gif" OnClientClick="if(!confirm('你确认要删除该用户所发表帖子吗？\n删除后将不能恢复！')) return false;"></cc1:Button>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <table>
                                                        <tr>
                                                            <td><cc1:Button ID="DelUserInfo" runat="server" Text="删除该用户" ButtonImgUrl="../images/del.gif" OnClientClick="if(!confirm('你确认要删除该用户吗？\n删除后将不能恢复！')) return false;"></cc1:Button>&nbsp;</td>
                                                            <td>
