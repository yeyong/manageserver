<%@ Page Language="C#" CodeBehind="global_emailconfig.aspx.cs" Inherits="SAS.ManageWeb.ManagePage.global_emailconfig" %>
...
<head>
    ...
    <title>天狼星工作室综合管理后台—系统邮箱配置</title>
            ...
            <tr>
                <td  class="panelbox" align="left" width="50%">
                    <table width="100%">
                        ...
                        <tr>
					        <td>系统邮箱密码:</td>
					        <td><cc1:TextBox id="password" textmode="password" runat="server" RequiredFieldType="暂无校验" CanBeNull="必填" Width="200" HintInfo="设置邮箱的密码"></cc1:TextBox></td>
                        </tr>
                    </table>
                </td>
