        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                catch
                {
                    ...
                    {
                        smtpemail.Items.Add(new ListItem(".net邮件发送程序", "SAS.Common.SysMailMessage,SAS.Common"));
                        smtpemail.Items.Add(new ListItem("Sirius studio邮件发送程序", "SAS.Common.SmtpMail,SAS.Common"));
                    }
                }
