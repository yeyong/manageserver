<%@ Page Language="C#" CodeBehind="global_forumlinksgrid.aspx.cs" Inherits="SAS.ManageWeb.ManagePage.global_forumlinksgrid" %>
...
<body>
	...
	<yy:DataGrid ID="DataGrid1" runat="server" IsFixConlumnControls="true" OnPageIndexChanged="DataGrid_PageIndexChanged" OnSortCommand="Sort_Grid">
		<Columns>
			...
			<asp:BoundColumn DataField="linkurl" SortExpression="linkurl" HeaderText="链接地址" />
	...
	<p style="text-align:right;">
		<yy:Button ID="SaveFriend" runat="server" Text="保存友情链接修改"></yy:Button>&nbsp;&nbsp;
		<button type="button" class="ManagerButton" id="Button2" onclick="BOX_show('neworedit');"><img src="../images/add.gif"/> 新建友情链接 </button>&nbsp;&nbsp;
		<yy:Button ID="DelRec" runat="server" Text=" 删 除 " ButtonImgUrl="../images/del.gif" Enabled="false" OnClientClick="if(!confirm('你确认要删除所选的友情链接吗？')) return false;"></yy:Button>
	</p>
</form>
