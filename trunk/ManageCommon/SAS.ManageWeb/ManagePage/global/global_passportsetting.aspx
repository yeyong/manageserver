<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="global_passportsetting.aspx.cs" Inherits="SAS.ManageWeb.ManagePage.global_passportsetting" %>
...
<table width="100%">
	...
	<tr>
		<td class="vtop rowform">
			<yy:TextBox id="appname" runat="server"  CanBeNull="必填" Width="250"></yy:TextBox>
		</td>
		<td class="vtop"></td>
	</tr>
	...
	<tr>
		<td class="vtop rowform">
			<yy:RadioButtonList ID="applicationtype" runat="server" RepeatColumns="2">
	...
	<tr>
		<td class="vtop rowform">
			<yy:TextBox id="appurl" runat="server" Width="250"></yy:TextBox>
		</td>
		<td class="vtop"></td>
	</tr>
	...
	<tr>
		<td class="vtop rowform">
			<yy:TextBox id="callbackurl" runat="server" CanBeNull="必填" Width="250"></yy:TextBox>
		</td>
    ...
    <tr>
        <td>
            <yy:RadioButtonList id="asyncmode" runat="server" RepeatColumns="3">
	...
	<td colspan="2">
		...
		<tr>
			<td class="vtop rowform"><yy:TextBox id="asyncurl" runat="server" Width="250"></yy:TextBox></td>
	...
	<td colspan="2">
		...
		<tr>
			<td class="vtop rowform"><yy:TextBox id="asynclist" runat="server" Wdith="250"></yy:TextBox></td>
	...
	<tr>
		<td class="vtop rowform">
			 <yy1:TextareaResize id="ipaddresses" runat="server" controlname="ipaddresses" HintPosOffSet="160" ></yy1:TextareaResize>
		</td>
...
<div class="Navbutton">
	...
	<yy:Button id="savepassportinfo" runat="server" Text=" 提 交 " OnClick="savepassportinfo_Click" ValidateForm="true"></yy:Button>&nbsp;&nbsp;
