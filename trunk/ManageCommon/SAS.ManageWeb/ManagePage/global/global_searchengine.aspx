<%@ Page Language="C#" CodeBehind="global_searchengine.aspx.cs" Inherits="SAS.ManageWeb.ManagePage.global_searchengine" %>
...
<fieldset>
	...
	<tr>
		<td class="vtop rowform">
			<yy:RadioButtonList ID="archiverstatus" runat="server" RepeatColumns="1" HintTitle="提示" HintShowType="down" HintHeight="80" HintTopFirefoxOffset="60">
	...
	<tr>
		<td class="vtop rowform">
			 <yy1:TextareaResize ID="seotitle" runat="server" cols="33" controlname="seotitle"></yy1:TextareaResize>
		</td>
	...
	<tr>
		<td class="vtop rowform">
			 <yy1:TextareaResize ID="seodescription" runat="server" cols="33" controlname="seodescription"></yy1:TextareaResize>
		</td>
	...
	<tr>
		<td class="vtop rowform">
			<yy1:TextareaResize ID="seokeywords" runat="server" cols="33" controlname="seokeywords"></yy1:TextareaResize>
		</td>
	...
	<tr>
		<td class="vtop rowform">
			 <yy1:TextareaResize ID="seohead" runat="server" cols="33" controlname="seohead"></yy1:TextareaResize>
		</td>
	...
	<div class="Navbutton">
		<yy:Button ID="SaveInfo" runat="server" Text=" 提 交 "></yy:Button>
	</div>
</fieldset>
</form>
</div>
