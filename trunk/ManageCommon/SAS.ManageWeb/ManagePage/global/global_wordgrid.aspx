<%@ Page Language="C#" CodeBehind="global_wordgrid.aspx.cs" Inherits="SAS.ManageWeb.ManagePage.global_wordgrid" %>
<%@ Register TagPrefix="sas" Namespace="SAS.Control" Assembly="SAS.Control" %>
<%@ Register TagPrefix="sas1" TagName="PageInfo" Src="../UserControls/PageInfo.ascx" %>
...
<sas1:PageInfo id="info2" runat="server" Icon="warning" Text="替换前的内容可以使用限定符 {x} 以限定相邻两字符间可忽略的文字，x 是忽略字符的个数。如 'a{1}s{2}s '(不含引号) 可以过滤 'ass' 也可过滤 'axsxs' 和 'axsxxs' 等等。<BR />查询的内容和替换的内容的最大长度为254个字符"></sas1:PageInfo>
<sas1:PageInfo id="PageInfo1" runat="server" Icon="warning" Text="如需禁止发布包含某个词语的文字，而不是替换过滤，请将其对应的替换内容设置为{BANNED}即可；如需当用户发布包含某个词语的文字时，自动标记为需要人工审核，而不直接显示或替换过滤，请将其对应的替换内容设置为{MOD}即可。<font color=red>设置 '{BANNED}' 或 '{MOD}' 请务必使用大写字母！</font>"></sas1:PageInfo>
<sas1:PageInfo id="info1" runat="server" Icon="information" Text="查询的内容和替换的内容为必填项, 为不影响程序效率, 请不要设置过多不需要的过滤内容"></sas1:PageInfo>
批量添加:<br />
...
<br />
  <sas:TextBox id="badwords" runat="server" HintShowType="down" CssClass="" RequiredFieldType="暂无校验" TextMode="MultiLine" Height="90px" Rows="4" Cols="50"  HintTitle="提示" HintInfo="禁止发布的词语" HintPosOffSet="160"></sas:TextBox>
  <br /><br />
  <sas:RadioButtonList id="radfilter" runat="server"  RepeatColumns="1" RepeatLayout="flow">
 ...
 <br />
<sas:Button ID="addbadwords" runat="server" Text="提 交" ></sas:Button><br /><br />
...
<p style="text-align:right;">
	<sas:Button ID="SaveWord" runat="server" Text="保存过滤词修改"></sas:Button>&nbsp;&nbsp;
	<button type="button" class="ManagerButton" id="Button2" onclick="BOX_show('neworedit');"><img src="../images/add.gif"/> 新建过滤词 </button>&nbsp;&nbsp;
	<sas:Button ID="DelRec" runat="server" Text=" 删 除 " ButtonImgUrl="../images/del.gif" Enabled="false" OnClientClick="if(!confirm('你确认要删除所选的词语过滤吗？')) return false;"></sas:Button>
</p>
...
<table width="100%">
	...
	<tr>
		<td class="vtop rowform">
			 <sas:TextBox ID="find" runat="server" RequiredFieldType="暂无校验" IsReplaceInvertedComma="true" MaxLength="254" Size="30"></sas:TextBox>
		</td>
		<td class="vtop"></td>
	</tr>
	...
	<tr>
		<td class="vtop rowform">
			 <sas:TextBox ID="replacement" runat="server" RequiredFieldType="暂无校验" MaxLength="254" Size="30"></sas:TextBox>
		</td>
		<td class="vtop"></td>
	</tr>
</table>
<div class="Navbutton">
	<sas:Button ID="AddNewRec" runat="server" Text=" 提 交 "></sas:Button>&nbsp;&nbsp;
