...
namespace SAS.ManageWeb.ManagePage
{
    public partial class managemenubackupfile : SAS.Web.UI.AdminPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (SASRequest.GetString("filename") != "")
            {
                Utils.RestoreFile(Utils.GetMapPath(BaseConfigs.GetSitePath.ToLower() + "admin/xml/backup/" + SASRequest.GetString("filename")),
                                  Utils.GetMapPath(BaseConfigs.GetSitePath.ToLower() + "admin/xml/navmenu.config"));
        ...
        {
            string backupname = SASRequest.GetString("backupname");
            if (backupname == "")
            {
