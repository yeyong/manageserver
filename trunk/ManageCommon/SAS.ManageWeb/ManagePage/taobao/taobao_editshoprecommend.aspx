<%@ Page Language="C#" CodeBehind="taobao_editshoprecommend.aspx.cs" Inherits="SAS.ManageWeb.ManagePage.taobao_editshoprecommend" %>
		...
		<table class="ntcplist">
            ...
            <td>
             <table class="datalist" cellspacing="0" rules="all" border="1" id="SelectItem" style="border-collapse:collapse;">
                  ...
                  <%foreach (SAS.Entity.ShopDetailInfo shopinfo in shoplist)
                    { %>
                  <tr class="mouseoutstyle" onmouseover="this.className='mouseoverstyle'" onmouseout="this.className='mouseoutstyle'" style="cursor:hand;">
                    <td nowrap="nowrap" style="border-color:#EAE9E1;border-width:1px;border-style:solid;"><input type="button" class="ManagerButton" value="删除" onclick="deleteItem(this,'<%=shopinfo.sid%>');"/></td>
                    <td style="border-color:#EAE9E1;border-width:1px;border-style:solid;"><img width="82px" height="82px" src="http://logo.taobao.com/shop-logo<%=shopinfo.pic_path%>"/></td>
                    <td style="border-color:#EAE9E1;border-width:1px;border-style:solid;"><%=shopinfo.title%></td>
                    <td style="border-color:#EAE9E1;border-width:1px;border-style:solid;"><%=shopinfo.nick%></td>
                    <td style="border-color:#EAE9E1;border-width:1px;border-style:solid;"><%=SAS.Common.TypeConverter.ObjectToFloat(shopinfo.commission_rate)%>%</td>
                    <td style="border-color:#EAE9E1;border-width:1px;border-style:solid;"><%=shopinfo.shop_type%></td>                    
                    <td style="border-color:#EAE9E1;border-width:1px;border-style:solid;"><img src='<%=shopinfo.consumer_protection?"../images/state2.gif":"../images/state2.gif"%>'/></td>
                    <td style="border-color:#EAE9E1;border-width:1px;border-style:solid;"><%=shopinfo.shop_level%></td> 
                    <td style="border-color:#EAE9E1;border-width:1px;border-style:solid;"><%=shopinfo.shop_score%></td> 
                    <td style="border-color:#EAE9E1;border-width:1px;border-style:solid;"><%=shopinfo.total_num%></td> 
                    <td style="border-color:#EAE9E1;border-width:1px;border-style:solid;"><%=shopinfo.good_num%></td> 
                    <td style="border-color:#EAE9E1;border-width:1px;border-style:solid;"><%=shopinfo.item_score%></td> 
                    <td style="border-color:#EAE9E1;border-width:1px;border-style:solid;"><%=shopinfo.service_score%></td> 
                    <td style="border-color:#EAE9E1;border-width:1px;border-style:solid;"><%=shopinfo.delivery_score%></td> 
                    <td style="border-color:#EAE9E1;border-width:1px;border-style:solid;"><%=shopinfo.shop_country + shopinfo.shop_province + shopinfo.shop_city%></td> 
                  </tr>
                  <%} %>
              </table>
              </td>
