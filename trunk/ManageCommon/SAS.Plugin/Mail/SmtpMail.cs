...
namespace SAS.Plugin.Mail
{
    ...
    /// 邮件发送程序
    /// </summary>
    [SmtpEmail("邮件发送程序", Version = "1.0", Author = "Sirius studio ", DllFileName = "SAS.PlugIn.dll")]
    public class SmtpMail : ISmtpMail
    {
        ...
        private bool SendEmail()
        {
            ...
            */
            ...
            SendBufferstr += "To:=?" + Charset.ToUpper() + "?B?" + (SAS.Common.Utils.StrIsNullOrEmpty(RecipientName) ? "" : Base64Encode(RecipientName)) + "?=" + "<" + Recipient[0] + ">" + enter;
